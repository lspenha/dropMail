  ...
  return (
    <>
      ...
      <div className="absolute w-full h-screen flex text-white z-50">
        <div className="w-full bg-gradient-to-r from-[#EF8D9C] to-[#FFC39E] rounded-lg text-center flex flex-col h-80 max-w-2xl m-auto">
          ...
          <button
            onClick={onClick}
            className="px-5 py-2.5 rounded-lg m-auto hover:shadow-lg flex items-center bg-[#24292F] hover:bg-[#24292F]/90 font-medium text-sm dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30"
          >
            {loading && (
              <div role="status">
                <svg
